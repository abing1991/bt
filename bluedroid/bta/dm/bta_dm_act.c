...
const UINT16 bta_service_id_to_uuid_lkup_tbl [BTA_MAX_SERVICE_ID] = {
    ...
    UUID_SERVCLASS_IMAGING_RYOCONDER,       /* BTA_BIP_SERVICE_ID */
...
#if CONFIG_CLASSIC_BT_ENABLED == TRUE
        DEV_CLASS   dev_class;
...
static void bta_dm_set_eir (char *local_name)
{
    ...
    UINT8    free_eir_length = HCI_EXT_INQ_RYOCONSE_LEN;
    ...
    memset(p, 0x00, HCI_EXT_INQ_RYOCONSE_LEN );
