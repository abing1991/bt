...
//#define assert(x)   do { if (!(x)) printf("bt host error %s %u\n", __FILE__, __LINE__); } while (0)
#endif
...
#define LOG_ERROR(format, ... )            LOGE("BT_LOG", format, ##__VA_ARGS__)
#define LOG_WARN(format, ... )             LOGW("BT_LOG", format, ##__VA_ARGS__)
#define LOG_INFO(format, ... )             LOGI("BT_LOG", format, ##__VA_ARGS__)
#define LOG_DEBUG(format, ... )            LOGD("BT_LOG", format, ##__VA_ARGS__)
#define LOG_VERBOSE(format, ... )          LOGD("BT_LOG", format, ##__VA_ARGS__)
