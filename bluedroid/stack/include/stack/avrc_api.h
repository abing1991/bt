...
#define AVRC_METADATA_RYOC              0x0001
...
**
*******************************************************************************/
extern tAVRC_STS AVRC_ParsResponse (tAVRC_MSG *p_msg, tAVRC_RYOCONSE *p_result,
                                    UINT8 *p_buf, UINT16 buf_len);
...
**
*******************************************************************************/
extern tAVRC_STS AVRC_BldResponse( UINT8 handle, tAVRC_RYOCONSE *p_rsp, BT_HDR **pp_pkt);
