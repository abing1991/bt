        ...
        for (int position = 0; position < p_adv_data->service_uuid_len; position += LEN_UUID_128) {
            ...
            case (LEN_UUID_16): {
                ...
                if (NULL != bta_adv_data->p_services->p_uuid) {
                    BTC_TRACE_DEBUG("%s - In 16-UUID_data %d", __FUNCTION__, bt_uuid.uu.uuid16);
            ...
            case (LEN_UUID_128): {
                ...
                if (NULL == bta_adv_data->p_services_128b) {
                    ...
                    if (NULL != bta_adv_data->p_services_128b) {
                        ...
                        BTC_TRACE_ERROR("%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x,%x", bt_uuid.uu.uuid128[0],
...
static void btc_ble_start_advertising (yoc_ble_adv_params_t *ble_adv_params, tBTA_START_ADV_CMPL_CBACK start_adv_cback)
{
    ...
    memcpy(peer_addr.bda, ble_adv_params->peer_addr, YOC_BD_ADDR_LEN);
