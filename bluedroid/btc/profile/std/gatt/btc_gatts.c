...
void btc_gatts_arg_deep_copy(btc_msg_t *msg, void *p_dest, void *p_src)
{
    ...
    case BTC_GATTS_ACT_SEND_RYOCONSE: {
        if (src->send_rsp.rsp) {
...
void btc_gatts_call_handler(btc_msg_t *msg)
{
   ...
   case BTC_GATTS_ACT_CREATE_ATTR_TAB:
    ...
    case BTC_GATTS_ACT_SEND_RYOCONSE: {
        ...
        param.rsp.status = 0;
        btc_gatts_cb_to_app(YOC_GATTS_RYOCONSE_EVT, BTC_GATT_GET_GATT_IF(arg->send_rsp.conn_id), &param);
        break;
    }
    case BTC_GATTS_ACT_SET_ATTR_VALUE:
...
void btc_gatts_cb_handler(btc_msg_t *msg)
{
    ...
    case BTA_GATTS_READ_EVT: {
        ...
        memcpy(param.read.bda, p_data->req_data.remote_bda, YOC_BD_ADDR_LEN);
    ...
    case BTA_GATTS_WRITE_EVT: {
        ...
        memcpy(param.write.bda, p_data->req_data.remote_bda, YOC_BD_ADDR_LEN);
    ...
    case BTA_GATTS_EXEC_WRITE_EVT: {
        ...
        memcpy(param.exec_write.bda, p_data->req_data.remote_bda, YOC_BD_ADDR_LEN);
        if (p_data->req_data.p_data == NULL) {
            break;
        }
    ...
    case BTA_GATTS_CONNECT_EVT:
        ...
        memcpy(param.connect.remote_bda, p_data->conn.remote_bda, YOC_BD_ADDR_LEN);
    ...
    case BTA_GATTS_DISCONNECT_EVT:
        ...
        memcpy(param.disconnect.remote_bda, p_data->conn.remote_bda, YOC_BD_ADDR_LEN);
