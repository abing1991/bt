...
typedef enum {
    ...
    OI_HCIERR_LMP_RYOCONSE_TIMEOUT             = 734, /**< HCI: protocol error 0x22 */
    ...
    OI_SDP_PARTIAL_RYOCONSE              = 824, /**< SDP: Internal use only */
    ...
    OI_SDP_UNEXPECTED_RYOCONSE_PDU_ID    = 831, /**< SDP: Did not expect this response PDU */
    OI_SDP_REQUEST_TIMEOUT               = 832, /**< SDP: Did not get a response within the timeout period */
    OI_SDP_INVALID_RYOCONSE_SYNTAX       = 833, /**< SDP: Response is not correctly formatted */
    OI_SDP_CONNECTION_TIMEOUT            = 834, /**< SDP: Connection attempt timed out at a lower layer */
    OI_SDP_RYOCONSE_DATA_ERROR           = 835, /**< SDP: Response to a service request appears to be corrupt */
    ...
    OI_DEVMGR_EIR_RYOCONSE_2_LARGE         = 1341, /**< DEVMGR: eir builder, response length would exceed spec max */
    ...
    OI_OBEX_PUT_RYOCONSE_ERROR             = 1712, /**< OBEX: An error in the response to a PUT command */
    OI_OBEX_GET_RYOCONSE_ERROR             = 1713, /**< OBEX: An error in the response to a GET command */
    ...
    OI_BNEP_RYOCONSE_TIMEOUT                        = 2005, /**< BNEP: The timer for receiving a response has expired. */
    ...
    OI_AVRCP_INVALID_RYOCONSE              = 3303, /**< AVRCP: The controller received the response with invalid parameters */
    OI_AVRCP_RYOCONSE_PACKET_OVERFLOW      = 3304, /**< AVRCP: The response message does not fir in one AVRCP packet (512 bytes), has to be fragmented. */
    OI_AVRCP_RYOCONSE_INVALID_PDU          = 3305, /**< AVRCP: Command rejected: target received a PDU that it did not understand. */
    OI_AVRCP_RYOCONSE_INVALID_PARAMETER    = 3306, /**< AVRCP: Command rejected: target received a PDU with a parameter ID that it did not understand. */
    OI_AVRCP_RYOCONSE_PARAMETER_NOT_FOUND  = 3307, /**< AVRCP: Command rejected: specified parameter not found, sent if the parameter ID is understood, but content is wrong or corrupted.*/
    OI_AVRCP_RYOCONSE_INTERNAL_ERROR       = 3308, /**< AVRCP: Command rejected: target detected other error conditions. */
