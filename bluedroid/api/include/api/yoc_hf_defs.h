...
typedef enum {
    YOC_HF_AT_RYOCONSE_CODE_OK = 0,         /*!< acknoweledges execution of a command line */
    YOC_HF_AT_RYOCONSE_CODE_ERR,            /*!< command not accepted */
    YOC_HF_AT_RYOCONSE_CODE_NO_CARRIER,     /*!< connection terminated */
    YOC_HF_AT_RYOCONSE_CODE_BUSY,           /*!< busy signal detected */
    YOC_HF_AT_RYOCONSE_CODE_NO_ANSWER,      /*!< connection completion timeout */
    YOC_HF_AT_RYOCONSE_CODE_DELAYED,        /*!< delayed */
    YOC_HF_AT_RYOCONSE_CODE_BLACKLISTED,    /*!< blacklisted */
    YOC_HF_AT_RYOCONSE_CODE_CME,            /*!< CME error */
