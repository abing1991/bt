 ...
 *
 */
yoc_err_t yoc_a2d_register_callback(yoc_a2d_cb_t callback);
 ...
 *
 */
yoc_err_t yoc_a2d_sink_register_data_callback(yoc_a2d_sink_data_cb_t callback);
 ...
 *
 */
yoc_err_t yoc_a2d_sink_init(void);
 ...
 *
 */
yoc_err_t yoc_a2d_sink_deinit(void);
 ...
 *
 */
yoc_err_t yoc_a2d_sink_connect(yoc_bd_addr_t remote_bda);
 ...
 *
 */
yoc_err_t yoc_a2d_sink_disconnect(yoc_bd_addr_t remote_bda);
 ...
 * @return
 *                  - YOC_OK: control command is sent to lower layer
 *                  - YOC_INVALID_STATE: if bluetooth stack is not yet enabled
 *                  - YOC_FAIL: others
 *
 */
yoc_err_t yoc_a2d_media_ctrl(yoc_a2d_media_ctrl_t ctrl);
 ...
 *
 */
yoc_err_t yoc_a2d_source_init(void);
 ...
 *
 */
yoc_err_t yoc_a2d_source_deinit(void);
 ...
 *
 */
yoc_err_t yoc_a2d_source_register_data_callback(yoc_a2d_source_data_cb_t callback);
 ...
 *
 */
yoc_err_t yoc_a2d_source_connect(yoc_bd_addr_t remote_bda);
 ...
 *
 */
yoc_err_t yoc_a2d_source_disconnect(yoc_bd_addr_t remote_bda);
