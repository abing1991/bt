...
#define YOC_BLUEDROID_STATUS_CHECK(status)           \
...
typedef enum {
    ...
    YOC_BT_STATUS_MEMORY_FULL,                  /* relate to BT_STATUS_MEMORY_FULL in bt_def.h */
} yoc_bt_status_t;
...
#define YOC_BD_ADDR_LEN     6

/// Bluetooth device address
typedef uint8_t yoc_bd_addr_t[YOC_BD_ADDR_LEN];
