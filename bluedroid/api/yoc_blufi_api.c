...
yoc_err_t yoc_blufi_register_callbacks(yoc_blufi_callbacks_t *callbacks)
{
    ...
    return (btc_profile_cb_set(BTC_PID_BLUFI, callbacks->event_cb) == 0 ? YOC_OK : YOC_FAIL);
}
...
yoc_err_t yoc_blufi_send_wifi_conn_report(wifi_mode_t opmode, yoc_blufi_sta_conn_state_t sta_conn_state, uint8_t softap_conn_num, yoc_blufi_extra_info_t *extra_info)
{
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_blufi_args_t), btc_blufi_call_deep_copy) == BT_STATUS_SUCCESS ? YOC_OK : YOC_FAIL);
}
...
yoc_err_t yoc_blufi_send_error_info(yoc_blufi_error_state_t state)
{
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_blufi_args_t), NULL) == BT_STATUS_SUCCESS ? YOC_OK : YOC_FAIL);
}
