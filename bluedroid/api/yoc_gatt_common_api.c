 ...
 *
 */
yoc_err_t yoc_ble_gatt_set_local_mtu (uint16_t mtu)
{
    btc_msg_t msg;
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gatt_com_args_t), NULL) == BT_STATUS_SUCCESS ? YOC_OK : YOC_FAIL);
}