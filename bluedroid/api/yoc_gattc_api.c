...
yoc_err_t yoc_ble_gattc_register_callback(yoc_gattc_cb_t callback)
{
...
yoc_err_t yoc_ble_gattc_app_register(uint16_t app_id)
{
    btc_msg_t msg;
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gattc_args_t), NULL) == BT_STATUS_SUCCESS ? YOC_OK : YOC_FAIL);
}

yoc_err_t yoc_ble_gattc_app_unregister(yoc_gatt_if_t gattc_if)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
...
yoc_err_t yoc_ble_gattc_open(yoc_gatt_if_t gattc_if, yoc_bd_addr_t remote_bda, yoc_ble_addr_type_t remote_addr_type, bool is_direct)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
    ...
    memcpy(arg.open.remote_bda, remote_bda, YOC_BD_ADDR_LEN);
...
yoc_err_t yoc_ble_gattc_close (yoc_gatt_if_t gattc_if, uint16_t conn_id)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
...
yoc_err_t yoc_ble_gattc_send_mtu_req (yoc_gatt_if_t gattc_if, uint16_t conn_id)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
...
yoc_err_t yoc_ble_gattc_search_service(yoc_gatt_if_t gattc_if, uint16_t conn_id, yoc_bt_uuid_t *filter_uuid)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
...
yoc_err_t yoc_ble_gattc_read_char (yoc_gatt_if_t gattc_if, 
...
yoc_err_t yoc_ble_gattc_read_multiple(yoc_gatt_if_t gattc_if,
...
yoc_err_t yoc_ble_gattc_read_char_descr (yoc_gatt_if_t gattc_if,
                                         uint16_t conn_id, uint16_t handle,
                                         yoc_gatt_auth_req_t auth_req)
{
    btc_msg_t msg;
...
yoc_err_t yoc_ble_gattc_write_char(yoc_gatt_if_t gattc_if,
                                   uint16_t conn_id, uint16_t handle,
                                   uint16_t value_len,
                                   uint8_t *value,
                                   ...
                                   yoc_gatt_auth_req_t auth_req)
{
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gattc_args_t), btc_gattc_arg_deep_copy) == BT_STATUS_SUCCESS ? YOC_OK : YOC_FAIL);
}

yoc_err_t yoc_ble_gattc_write_char_descr (yoc_gatt_if_t gattc_if,
                                          uint16_t conn_id, uint16_t handle,
                                          uint16_t value_len,
                                          uint8_t *value,
                                          yoc_gatt_write_type_t write_type,
...
yoc_err_t yoc_ble_gattc_prepare_write(yoc_gatt_if_t gattc_if, 
                                      uint16_t conn_id, uint16_t handle,
                                      uint16_t offset,
                                      uint16_t value_len,
                                      uint8_t *value,
...
yoc_err_t yoc_ble_gattc_prepare_write_char_descr(yoc_gatt_if_t gattc_if,
                                                 uint16_t conn_id, uint16_t handle,
                                                 uint16_t offset,
                                                 uint16_t value_len,
                                                 uint8_t *value,
...
yoc_err_t yoc_ble_gattc_execute_write (yoc_gatt_if_t gattc_if, uint16_t conn_id, bool is_execute)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
...
yoc_err_t yoc_ble_gattc_register_for_notify (yoc_gatt_if_t gattc_if,
...
yoc_err_t yoc_ble_gattc_unregister_for_notify (yoc_gatt_if_t gattc_if,
                                               yoc_bd_addr_t server_bda, uint16_t handle)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
...
yoc_err_t yoc_ble_gattc_cache_refresh(yoc_bd_addr_t remote_bda)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
...
yoc_err_t yoc_ble_gattc_cache_assoc(yoc_gatt_if_t gattc_if, yoc_bd_addr_t src_addr, yoc_bd_addr_t assoc_addr, bool is_assoc)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
...
yoc_err_t yoc_ble_gattc_cache_get_addr_list(yoc_gatt_if_t gattc_if)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
