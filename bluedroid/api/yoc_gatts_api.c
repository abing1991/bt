...
static yoc_err_t yoc_ble_gatts_add_char_desc_param_check(yoc_attr_value_t *char_val, yoc_attr_control_t *control);


yoc_err_t yoc_ble_gatts_register_callback(yoc_gatts_cb_t callback)
{
    YOC_BLUEDROID_STATUS_CHECK(YOC_BLUEDROID_STATUS_ENABLED);

    return (btc_profile_cb_set(BTC_PID_GATTS, callback) == 0 ? YOC_OK : YOC_FAIL);
}

yoc_err_t yoc_ble_gatts_app_register(uint16_t app_id)
{
    btc_msg_t msg;
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gatts_args_t), NULL) == BT_STATUS_SUCCESS ? YOC_OK : YOC_FAIL);
}


yoc_err_t yoc_ble_gatts_app_unregister(yoc_gatt_if_t gatts_if)
{
    btc_msg_t msg;
    btc_ble_gatts_args_t arg;
...
yoc_err_t yoc_ble_gatts_create_service(yoc_gatt_if_t gatts_if,
...
yoc_err_t yoc_ble_gatts_create_attr_tab(const yoc_gatts_attr_db_t *gatts_attr_db,
...
yoc_err_t yoc_ble_gatts_add_included_service(uint16_t service_handle, uint16_t included_service_handle)
{
    btc_msg_t msg;
    btc_ble_gatts_args_t arg;
...
yoc_err_t yoc_ble_gatts_add_char(uint16_t service_handle,  yoc_bt_uuid_t  *char_uuid,
                                 ...
                                 yoc_attr_control_t *control)
{
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gatts_args_t), btc_gatts_arg_deep_copy) == BT_STATUS_SUCCESS ? YOC_OK : YOC_FAIL);
}


yoc_err_t yoc_ble_gatts_add_char_descr (uint16_t service_handle,
...
yoc_err_t yoc_ble_gatts_delete_service(uint16_t service_handle)
{
    btc_msg_t msg;
    btc_ble_gatts_args_t arg;
...
yoc_err_t yoc_ble_gatts_start_service(uint16_t service_handle)
{
    btc_msg_t msg;
    btc_ble_gatts_args_t arg;
...
yoc_err_t yoc_ble_gatts_stop_service(uint16_t service_handle)
{
    btc_msg_t msg;
    btc_ble_gatts_args_t arg;
...
yoc_err_t yoc_ble_gatts_send_indicate(yoc_gatt_if_t gatts_if, uint16_t conn_id, uint16_t attr_handle,
                                      uint16_t value_len, uint8_t *value, bool need_confirm)
{
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gatts_args_t),
                                 btc_gatts_arg_deep_copy) == BT_STATUS_SUCCESS ? YOC_OK : YOC_FAIL);
}

yoc_err_t yoc_ble_gatts_send_response(yoc_gatt_if_t gatts_if, uint16_t conn_id, uint32_t trans_id,
                                      yoc_gatt_status_t status, yoc_gatt_rsp_t *rsp)
{
    ...
    msg.sig = BTC_SIG_API_CALL;
    msg.pid = BTC_PID_GATTS;
    msg.act = BTC_GATTS_ACT_SEND_RYOCONSE;
...
yoc_err_t yoc_ble_gatts_set_attr_value(uint16_t attr_handle, uint16_t length, const uint8_t *value)
{
    btc_msg_t msg;
    btc_ble_gatts_args_t arg;
...
yoc_err_t yoc_ble_gatts_open(yoc_gatt_if_t gatts_if, yoc_bd_addr_t remote_bda, bool is_direct)
{
    btc_msg_t msg;
    btc_ble_gatts_args_t arg;
...
yoc_err_t yoc_ble_gatts_close(yoc_gatt_if_t gatts_if, uint16_t conn_id)
{
    btc_msg_t msg;
    btc_ble_gatts_args_t arg;
...
static yoc_err_t yoc_ble_gatts_add_char_desc_param_check(yoc_attr_value_t *char_val, yoc_attr_control_t *control)
{
    if ((control != NULL) && ((control->auto_rsp != YOC_GATT_AUTO_RSP) && (control->auto_rsp != YOC_GATT_RSP_BY_APP))){
            LOG_ERROR("Error in %s, line=%d, control->auto_rsp should be set to YOC_GATT_AUTO_RSP or YOC_GATT_RSP_BY_APP\n",\
                            __func__, __LINE__);
            return YOC_ERR_INVALID_ARG;
    }
