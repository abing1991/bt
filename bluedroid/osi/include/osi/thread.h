...
#ifndef CONFIG_A2DP_SOURCE_TASK_STACK_SIZE
#define CONFIG_A2DP_SOURCE_TASK_STACK_SIZE 3072
#endif

#define HCI_HOST_TASK_STACK_SIZE        (2048 + BT_TASK_EXTRA_STACK_SIZE)
#define HCI_HOST_TASK_PRIO              (AOS_DEFAULT_APP_PRI - 3)
#define HCI_HOST_TASK_NAME              "hciHostT"
#define HCI_HOST_QUEUE_LEN              40

#define HCI_H4_TASK_STACK_SIZE          (2048 + BT_TASK_EXTRA_STACK_SIZE)
#define HCI_H4_TASK_PRIO                (AOS_DEFAULT_APP_PRI - 5)
#define HCI_H4_TASK_NAME                "hciH4T"
#define HCI_H4_QUEUE_LEN                128

#define HCI_H5_TASK_STACK_SIZE          (2048 + BT_TASK_EXTRA_STACK_SIZE)
#define HCI_H5_TASK_PRIO                (AOS_DEFAULT_APP_PRI - 5)
#define HCI_H5_TASK_NAME                "hciH5T"
#define HCI_H5_QUEUE_LEN                128

#define BTU_TASK_STACK_SIZE             (4096 + BT_TASK_EXTRA_STACK_SIZE)
#define BTU_TASK_PRIO                   (AOS_DEFAULT_APP_PRI - 1)
...
#define BTC_TASK_PRIO                   (AOS_DEFAULT_APP_PRI - 1)
...
#define BTC_A2DP_SINK_TASK_PRIO               (AOS_DEFAULT_APP_PRI - 3)
#define BTC_A2DP_SINK_DATA_QUEUE_LEN          (3)
#define BTC_A2DP_SINK_CTRL_QUEUE_LEN          (5)
#define BTC_A2DP_SINK_QUEUE_LEN               (8)
...
#define BTC_A2DP_SOURCE_TASK_PRIO             (AOS_DEFAULT_APP_PRI - 3)
...
#define TASK_POST_BLOCKING              (AOS_WAIT_FOREVER)
